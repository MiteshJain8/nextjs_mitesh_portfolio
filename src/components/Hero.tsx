...
const Hero = () => {
    return (
        <div className="py-24 relative overflow-clip bg-[linear-gradient(to_bottom,#000,#2B1947_35%,#8F5C55_60%,#DBAF6E_80%)]">
            <div className="absolute rounded-[50%] w-[2200px] md:w-[3000px] h-[1300px] top-[570px] sm:top-[700px] md:top-[750px] lg:top-[800px] left-[50%] -translate-x-1/2 bg-[radial-gradient(closest-side,#000_80%,#2B1947)]"></div>
